...
TARGET="CryptoKittiesAuction"
TARGET_PACKAGE_PATH="$(pwd)/Examples/CryptoKitties/Auction"
...
wasm-ld --no-entry --allow-undefined $OBJECT_FILE_PATH "/Users/quentin/IdeaProjects/mx-sdk-swift/Utils/Memory/memcpy.o" -o $WASM_BUILT_FILE_PATH
